...
def url_encode():
  echo = urllib.parse.quote("String I want in here(the shells that want to be URL encoded by the user.)", safe='')
  print(echo)
...
# TODO: Work on functions for encoding options & shell options. UPDATE 1: DONE WITH SINGLE URL ENCODING
